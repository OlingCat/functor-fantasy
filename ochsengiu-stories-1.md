...
等我把它分解开并且复制出来已经到了中午了，我大概分析出了几个东西，比如用来控制复制性的开关，把它拔掉自我复制就会启动，插上则停止；以及它用来做计算机的方法——通过「旋转」的方式扭曲内存内的电荷分布。自我复制的部分还没有多少进展，我能感觉到是它那个精巧的结构可以去「读」环状结构里面用源体编码的「程序」并且按照程序构造自己，但让程序包含自身的设计我还是没怎么看出来，不过时间已经不早，我便和更纱出门去吃午餐。
